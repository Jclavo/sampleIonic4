...
export class MinhacontaPage implements OnInit {
  ...
  @ViewChild('imgresult', {static: false}) imgResult: ElementRef;
  ...
  */
  ...
  ionViewDidEnter() {
    ...
    // if (!this.authService.HashKey) {
    //   this.navCtrl.navigateRoot('/login');
    // } else {
    //   this.MostraDados(this.authService.CodigoUsuarioSistema);
    // }
  ...
  MostraDados(CodigoUsuario: any) {
    ...
    this.authService.QueryStoreProc('MinhaConta', 'spMinhaConta', params).then(res => {
